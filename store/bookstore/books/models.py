...
class Books(BaseModel):
    ...
    # type_id = models.SmallIntegerField(default=PYTHON, choices=books_type_choices, verbose_name='type_id')
    # name = models.CharField(max_length=20, verbose_name='name')
    # desc = models.CharField(max_length=128, verbose_name='desc')
    ...
    # status = models.SmallIntegerField(default=ONLINE, choices=status_choices, verbose_name='status')
